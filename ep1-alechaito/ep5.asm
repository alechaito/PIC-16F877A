...
salvar_func:
	...
	; Resetando valores do display 2
	bcf	PORTD,0
	bcf	PORTD,1
	bcf	PORTD,2
	bcf	PORTD,3
	
	; Resetando valores do display 1
	bcf	PORTC,0
	bcf	PORTC,1
	bcf	PORTC,2
	bcf	PORTC,3
...
verify_count:
	bsf	led
	; Faco um xor entre a porta C atual e a porta C SALVA
	movf	auxportc,W
